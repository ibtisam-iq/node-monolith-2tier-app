...
> **Repository:** `3TierUserApp-ReactNode-MySQL`
> **Stack:** React (Frontend) · Node.js + Express (Backend) · MySQL (Database)
> **Purpose:** This document explains what was wrong with the original codebase, why it was classified as 2-tier (or a broken attempt at 3-tier), and exactly what was changed, added, and deleted to produce a proper 3-tier architecture.

---

## Table of Contents

1. [What Is a Tier? (Plain English)](#1-what-is-a-tier-plain-english)
...
## 1. What Is a Tier? (Plain English)
